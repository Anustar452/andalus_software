<!DOCTYPE html>
<html lang="zxx">
  <!-- Mirrored from cutesolution.com/html/techvio/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Mar 2024 09:35:12 GMT -->
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    <meta
    ...
    <!-- Title -->
    <title>
      Techvio - IT Solutions & Business Services Multipurpose HTML5 Website
      Template
    </title>
    <!-- Google Fonts -->
    <link
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="nav-item">
                      <a href="single-services" class="nav-link"
                        >Services Details</a
                      >
                    </li>
                  </ul>
              ...
              <ul class="accordion">
                <li class="accordion-item">
                  <a class="accordion-title active" href="javascript:void(0)">
                    <i class="fa fa-plus"></i> How long does a website redesign
                    take?</a
                  >
                  <p class="accordion-content show">
                    ...
                    occaecat cupidatat non proident, sunt in culpa officia
                    deserunt mollit anim id est laborum.
                  </p>
                </li>
                <!-- <li class="accordion-item">
                  <a class="accordion-title" href="javascript:void(0)">
                    <i class="fa fa-plus"></i> What happens if my site
                    breaks?</a
                  >
                ...
                <li class="accordion-item">
                  <a class="accordion-title" href="javascript:void(0)">
                    <i class="fa fa-plus"></i> What is the difference between my
                    CMS, DNS, hosting, FTP, etc.?</a
                  >
                  <p class="accordion-content">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                ...
                <li class="accordion-item">
                  <a class="accordion-title" href="javascript:void(0)">
                    <i class="fa fa-plus"></i> Can you handle ongoing
                    maintenance?</a
                  >
                  <p class="accordion-content">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                ...
                <li class="accordion-item">
                  <a class="accordion-title" href="javascript:void(0)">
                    <i class="fa fa-plus"></i> Do you only create WordPress
                    websites?</a
                  >
                  <p class="accordion-content">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                ...
                <li class="accordion-item">
                  <a class="accordion-title" href="javascript:void(0)">
                    <i class="fa fa-plus"></i> Can I update the website myself
                    once it’s built?</a
                  >
                  <p class="accordion-content">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
