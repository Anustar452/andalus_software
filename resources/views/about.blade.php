        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="feature-single-item">
              ...
              <p>Don't Be Held Back by Rigid Software. Choose Flexibility.</p>
              <div class="feature-btn-box">
                <a href="#" class="read-more"
                  ><i class="bi bi-arrow-right-short"></i> Learn More</a
                >
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="feature-single-item">
              ...
              <p>
                We Don't Just Write Code, We Write Success Stories: Meet Our
                Dedicated Teams
              </p>
              <div class="feature-btn-box">
                <a href="#" class="read-more"
          ...
          <div class="col-lg-4 col-md-6">
            <div class="feature-single-item">
              ...
              <p>
                Delivering value, not just code. Building a business, not just
                software.
              </p>
              <div class="feature-btn-box">
                <a href="#" class="read-more"
          ...
          <div class="col-lg-3 col-md-6">
            <div class="workprocess-single-item">
              ...
              <div class="workprocess-info">
                <h3>Discover</h3>
                <p>
                  the process of understanding the challenges and difficulties
          ...
          <div class="col-lg-3 col-md-6">
            <div class="workprocess-single-item">
              ...
              <div class="workprocess-info">
                ...
                <p>
                  This stage focuses on planning and creating the blueprint for
                  the software and the designers' plans are transformed into a
          ...
          <div class="col-lg-3 col-md-6">
            <div class="workprocess-single-item">
              ...
              <div class="workprocess-info">
                ...
                <p>
                  This focuses on ensuring the software can be installed
                  correctly on a user's system. It involves and encompassing
                  various tests performed on the software itself to identify and
                  fix bugs before it reaches the end-user.
                </p>
              </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="workprocess-single-item">
              ...
              <div class="workprocess-info">
                ...
                <p>
                  It refers to the entire lifecycle of bringing a software
                  product or feature to life, from its initial conception all
                  the way to getting it into the hands of the users.
                </p>
              </div>
